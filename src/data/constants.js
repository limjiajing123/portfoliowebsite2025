export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1oqkQ-9Xucwn5FwceBcyiH-gh862OdFLr/view?usp=drive_link",
  ...
  // },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Postman",
        image:
          "https://camo.githubusercontent.com/e948344dc92e2ce2a9d4d00be03ac1b70e3f9b962e410867d4816be3e7015c11/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f506f73746d616e2d4646364333373f7374796c653d666f722d7468652d6261646765266c6f676f3d506f73746d616e266c6f676f436f6c6f723d7768697465",
      },
      {
        name: "GoLang",
        image:
...
export const experiences = [
  ...
  },
  {
    ...
    desc: ` Hands-on experience with ROS1/ROS2 navigation stack
            Experienced in SLAM tools such as Cartographer and Gmapping etc. for mapping the environment.
            Developed and implemented Simultaneous Localisation and Mapping (SLAM) algorithm, localisation fusion algorithm, map and route editor application software, on-site deployment or demonstration of autonomous mobile robot.
            Experienced with sensor modules such as IMU & LiDAR to gather and process sensor data for robotics applications using ROS 1 and ROS 2 API
            Created and demonstrated visualisation for the robot in Rviz based on IMU’s heading to clients for a project.
            Developed Go lang executables to enhance an existing robotics management system, improving real-time responsiveness and efficiency.  
            Containerised multiple projects’ application using Docker for backend robotic management system which simplified deployment and ensured consistent performance across environments.
            Wrote software requirements, architecture, and design for various project documentation. 
            Documented process and instruction for colleagues’ future reference and implementation 
...
export const education = [
  {
    ...
    desc: "Graduated with Honours Distinction of class 2024. Eager to know more about the world",
    degree: "Bachelor of Mechanical Engineering Specialization in Robotics and Mechatronics",
  },
  {
    id: 1,
    img: "https://www.elca.com.sg/assets/andersonjclogo.jpg",
    school: "Anderson Junior College, Singapore",
    date: "Feb 2016 - Dec 2017",
    grade: "Graduated",
    desc: "Subject combination: H2 Physics, H2 Chemistry, H2 Mathematics, H1 Economics",
    degree: "A-Level, PCME",
  },
  // {
  //   id: 2,
...
export const projects = [
  ...
  {
    id: 0,
    title: "Final Year Project with Rehabilitation Research institute of Singapore (RRIS): Evaluating Navigation Among Crowd Algorithms For Shared Control Of A Robotic Wheelchair",
    date: "Aug 2023 - June 2024",
    description:
      ` Shared control of robotic wheelchair can help people with disability operate wheelchair safely and efficiently. 
        The objective of this project is to develop algorithms which can help robotic wheelchair navigate in the crowd in a shared control setting. 
        Surveyed existing autonomous navigation among crowd algorithms.
        Integration of an self-modified existing algorithm for shared control inhouse-system and evaluated its performance in Gazebo with Gamma simulator.
        Created and modified GUI and visualization tool in Rviz to showcase the effects of the algorithm.
        Make recommendations for the best algorithm to use for shared control amongst crowd.
  ...
  {
    id: 1,
    title: "Robotic Arm from scratch",
    date: "Aug 2023 - Nov 2023",
    description:
      ` Led the design of an efficient and adaptable end-effector for the robotic arm using SolidWorks. Ensured seamless integration with the robot arm for optimal performance in object retrieval tasks.
        Converted SolidWorks files to URDF format, facilitating integration with the Robot Operating System (ROS) simulation environment. Enabled accurate representation and simulation of the robotic arm for testing and validation.
        Developed and executed simulations using ROS MoveIt and Rviz to emulate diverse scenarios.
  ...
  {
    id: 2,
    title: "MA4012 Design Of A Compact Autonomous Vehicle",
    date: "Aug 2023 - Nov 2023",
    description:
      ` Designed and constructed the vehicle chassis with consideration for efficient wire placement and software integration.
        Collaborated design of the ball collection and deposition mechanism, ensuring functionality and reliability.
        Designed and integrated the VEX controller to enhance edge detection, target tracking, and ball retrieval.
  ...
  {
    id: 10,
    title: "RealTime Software for Mechatronics System. Waveform Generator in C programming Language",
